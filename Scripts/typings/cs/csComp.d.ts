...
declare module csComp.Services {
    ...
    class LayerService {
        ...
        */
        ...
        selectFeature(feature: IFeature, multi?: boolean): void;
        updateAllLogs(): void;
...
declare module LayersDirective {
    ...
    class LayersDirectiveCtrl {
        ...
        layerGroup: any;
        static $inject: string[];
        constructor($scope: ILayersDirectiveScope, $layerService: csComp.Services.LayerService, $messageBusService: csComp.Services.MessageBusService, $mapService: csComp.Services.MapService, $dashboardService: csComp.Services.DashboardService, $modal: any);
...
declare module ChartsWidget {
    ...
    class ChartsEditCtrl {
        ...
        editor: any;
        static $inject: string[];
        constructor($scope: IChartsEditCtrl, $timeout: ng.ITimeoutService, $compile: any, $layerService: csComp.Services.LayerService, $templateCache: any, $messageBus: csComp.Services.MessageBusService, $mapService: csComp.Services.MapService, $dashboardService: csComp.Services.DashboardService);
        setupEditor(): void;
        loadChart(): void;
        updateChart(): void;
        refreshChart(): void;
